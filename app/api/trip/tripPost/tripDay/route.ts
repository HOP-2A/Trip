  ...
  const response = await prisma.tripDay.createMany({
    data: [
      ...
      },
      {
        ...
        description:
          "Өглөө Асакуса дахь Сенсожи сүмд зочилж, Накамисэ худалдааны гудамжаар тойрно. Дараа нь Токио Скайтрий цамхгаас хотыг бүхэлд нь 360° харах боломжтой. Орой Сумида голын эрэгт тайван алхана.",
      },
      {
        tripPlanId: "BCtl1xoW_YznjYbx7EkZz",
        dayNumber: 3,
        ...
        description:
          "Өдрийн эхний хэсэгт алдарт Шибүяа товчоо гарц дээр зураг дарж, Шибүяа Скай руу гарч хотын панорамыг үзнэ. Дараа нь Харужүкүгийн Такишита гудамжаар шоппинг хийж, Япон залуучуудын соёлыг мэдэрнэ. Орой Омотесандогоор алхахад тохиромжтой.",
      },
      {
        tripPlanId: "BCtl1xoW_YznjYbx7EkZz",
        dayNumber: 4,
        ...
        description:
          "Уено парк руу очиж, байгалтай өдрийг өнгөрөөнө. Токио үндэсний музей, Уено амьтны хүрээлэн эсвэл цөөрмийн эргээр завь унах боломжтой. Орой Амэёко худалдааны гудамжид амттан, street food туршина.",
      },
      {
        tripPlanId: "BCtl1xoW_YznjYbx7EkZz",
        dayNumber: 5,
        ...
        description:
          "Акаихабара гудамжинд технологи, электроник дэлгүүрүүдээр орж үзнэ. Анимэ, манга, тоглоом сонирходог бол энэ өдөр бүхэлдээ адал явдалтай. Мэйд кафе эсвэл тэмдэгт баатруудын сэдэвт кафег сонирхож болно.",
      },
      {
        tripPlanId: "BCtl1xoW_YznjYbx7EkZz",
        dayNumber: 6,
        ...
        description:
          "Өглөө эрт Фүжи уулын орчим руу аялж, Кавагути нуурын эрэг дээрээс Фүжиг хараад зураг авна. Хаконед очвол халуун рашаанд (onsen) амран, рашаанд дүрэх Япон уламжлалыг мэдэрнэ. Орой Токио руу буцна.",
      },
      {
        tripPlanId: "BCtl1xoW_YznjYbx7EkZz",
        dayNumber: 7,
        ...
        description:
          "Цукидзи гадаад зах дээр хамгийн амттай сүши, далайн бүтээгдэхүүн амтална. Дараа нь Гинза дүүргээр явж, Японы тансаг дэлгүүр, брендүүдээр сонирхож болно. Орой театрт шоу үзэх эсвэл зүгээр л тансаг кафе-д амрах боломжтой.",
      },

      {
        ...
        description:
          "Роппонги арт дүүрэгт Моригийн музей болон Моригийн цамхгийн ажиглалтын тавцан дээр гарна. Оройд нь Токиогийн шилдэг rooftop бар-аас шөнийн гэрлүүдийг харан бусдаас өөр өнцгөөр мэдэрнэ.",
      },
      {
        tripPlanId: "BCtl1xoW_YznjYbx7EkZz",
        dayNumber: 10,
        ...
        description:
          "Сүүлчийн өдөр багахан шоппинг хийж, дурсгалын зүйлс худалдан авна. Буудлын ойролцоо амархан алхалт хийж, дараа нь нисэх буудал руу хөдөлнө. Токио хотын мартагдашгүй аялал өндөрлөнө.",
      },
      {
